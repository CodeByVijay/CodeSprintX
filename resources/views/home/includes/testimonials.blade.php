<section class="py-16 bg-white" id="testimonials" aria-labelledby="testimonials-title">
    <div class="container mx-auto px-4">
        ...
        <div class="testimonial-slider relative max-w-7xl mx-auto" data-aos="fade-up" data-aos-delay="100" aria-roledescription="carousel" aria-label="Student testimonials">
            <div class="testimonial-track flex transition-transform duration-500 ease-in-out" role="list" tabindex="0">
                ...
                <div class="testimonial-slide w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-4" aria-roledescription="slide" aria-label="Testimonial from Neha Gupta" role="listitem">
                    <div class="bg-gray-50 rounded-lg shadow-md p-8 h-full transition-all duration-300 hover:shadow-lg">
                        ...
                        <p class="text-gray-700 italic">"The data science program at CodeSprintX gave me practical knowledge of machine learning algorithms and data visualization techniques. I'm now working as a junior data analyst thanks to this internship."</p>
                        <div class="mt-4 text-yellow-400">
                ...
                <div class="testimonial-slide w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-4" aria-roledescription="slide" aria-label="Testimonial from Vikram Singh" role="listitem">
                    <div class="bg-gray-50 rounded-lg shadow-md p-8 h-full transition-all duration-300 hover:shadow-lg">
                        ...
                        <p class="text-gray-700 italic">"I learned React Native through the 6-month mobile app development internship. The hands-on approach and real client projects helped me build a strong portfolio that impressed recruiters."</p>
                        <div class="mt-4 text-yellow-400">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="testimonial-slide w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-4" aria-roledescription="slide" aria-label="Testimonial from Anjali Desai" role="listitem">
                    <div class="bg-gray-50 rounded-lg shadow-md p-8 h-full transition-all duration-300 hover:shadow-lg">
                        ...
                        <p class="text-gray-700 italic">"The UI/UX design internship at CodeSprintX taught me both theory and practical skills. The mentors provided valuable feedback on my designs, which helped me improve rapidly."</p>
                        <div class="mt-4 text-yellow-400">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="testimonial-slide w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-4" aria-roledescription="slide" aria-label="Testimonial from Rohan Kapoor" role="listitem">
                    <div class="bg-gray-50 rounded-lg shadow-md p-8 h-full transition-all duration-300 hover:shadow-lg">
                        ...
                        <p class="text-gray-700 italic">"During my cybersecurity internship at CodeSprintX, I worked on real-world security audits and vulnerability assessments. This practical experience was invaluable for my career development."</p>
                        <div class="mt-4 text-yellow-400">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="testimonial-slide w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-4" aria-roledescription="slide" aria-label="Testimonial from Divya Malhotra" role="listitem">
                    <div class="bg-gray-50 rounded-lg shadow-md p-8 h-full transition-all duration-300 hover:shadow-lg">
                        ...
                        <p class="text-gray-700 italic">"The AI/ML internship at CodeSprintX exposed me to cutting-edge technologies and applications. I gained hands-on experience in building and deploying machine learning models for real business problems."</p>
                        <div class="mt-4 text-yellow-400">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
            ...
            <!-- Navigation Arrows -->
            <button class="testimonial-prev absolute top-1/2 left-1 sm:left-2 md:left-4 transform -translate-y-1/2 bg-white p-1.5 sm:p-2 rounded-full shadow-md z-10 focus:outline-none hover:bg-gray-100 transition-colors" aria-label="Previous testimonial">
                <svg class="w-4 h-4 sm:w-6 sm:h-6 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                </svg>
            </button>

            <button class="testimonial-next absolute top-1/2 right-1 sm:right-2 md:right-4 transform -translate-y-1/2 bg-white p-1.5 sm:p-2 rounded-full shadow-md z-10 focus:outline-none hover:bg-gray-100 transition-colors" aria-label="Next testimonial">
                <svg class="w-4 h-4 sm:w-6 sm:h-6 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Pagination Dots -->
            <div class="testimonial-dots flex justify-center mt-6 sm:mt-8 space-x-2" role="tablist" aria-label="Testimonial pagination">
  ...
  "review": [
    {
      ...
      "reviewBody": "The 6-month web development internship at CodeSprintX was a game-changer for me. The structured learning path and real-world projects helped me land a job immediately after completion."
    },
    {
      "@type": "Review",
      "author": {
      ...
      "reviewBody": "I took the 3-month Python internship program and was amazed at how much I learned in such a short time. The mentors were supportive and the curriculum was comprehensive."
    },
    {
      "@type": "Review",
      "author": {
      ...
      "reviewBody": "The Java internship at CodeSprintX provided me with hands-on experience in enterprise application development. The skills I gained are extremely valuable in today's job market."
    }
  ]
}
</script>
