        ...
        $('.razorpay-buy-btn').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Use our helper function to initialize Razorpay
                    initializeRazorpay(options)
                        .then(function() {
                            console.log('Razorpay checkout completed or closed');
                            // Reset button state
                            button.prop('disabled', false).html('Buy Now');
                        })
                        .catch(function(error) {
                            console.error('Error with Razorpay:', error);
                            alert('There was an error with the payment gateway: ' + error.message);
                            // Reset button state
                            button.prop('disabled', false).html('Buy Now');
                        });
                },
