...
@section('content')
    ...
    <!-- Login Section -->
    <section
        class="py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen flex items-center relative overflow-hidden">
        <!-- Background Pattern -->
        <div class="absolute inset-0 opacity-10">
            <div class="absolute inset-0"
                style="background-image: url('data:image/svg+xml,%3Csvg width=&quot;100&quot; height=&quot;100&quot; viewBox=&quot;0 0 100 100&quot; xmlns=&quot;http://www.w3.org/2000/svg&quot;%3E%3Cpath d=&quot;M0 0h100v100H0z&quot; fill=&quot;none&quot;/%3E%3Cpath d=&quot;M0 0l100 100M100 0L0 100&quot; stroke=&quot;%233B82F6&quot; stroke-width=&quot;0.5&quot; opacity=&quot;0.3&quot;/%3E%3C/svg%3E');">
            </div>
        </div>
                        ...
                        <form action="{{ route('auth.login') }}" method="POST" class="space-y-6">
                            ...
                            <div class="form-group relative group">
                                ...
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                        <i
                                            class="fas fa-envelope text-gray-400 group-focus-within:text-primary transition-colors duration-300"></i>
                                    </div>
                            ...
                            <div class="form-group relative group">
                                <div class="flex justify-between mb-2">
                                    <label for="password"
                                        class="text-gray-700 font-medium text-sm group-focus-within:text-xs group-focus-within:text-primary transition-all duration-300">Password</label>
                                    <a href="#"
                                        class="text-sm text-primary hover:text-secondary font-medium transition-colors duration-300">Forgot
                                        Password?</a>
                                </div>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
                                        <i
                                            class="fas fa-lock text-gray-400 group-focus-within:text-primary transition-colors duration-300"></i>
                                    </div>
